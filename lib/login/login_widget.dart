...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signipEmailTextController ??= TextEditingController();
    _model.signipEmailFocusNode ??= FocusNode();

    _model.signupPasswordTextController ??= TextEditingController();
    _model.signupPasswordFocusNode ??= FocusNode();

    _model.signupCofirmPasswordTextController ??= TextEditingController();
    _model.signupCofirmPasswordFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Screenshot_2025-02-05_154145.png',
                        width: 160.0,
                        fit: BoxFit.contain,
                      ),
                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.signipEmailTextController,
                                          focusNode:
                                              _model.signipEmailFocusNode,
                                          onChanged: (_) =>
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .signipEmailTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Container(
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signupCofirmPasswordTextController,
                                          focusNode: _model
                                              .signupCofirmPasswordFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.done,
                                          obscureText: !_model
                                              .signupCofirmPasswordVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                            ...
                                            suffixIcon: InkWell(
                                              ...
                                              focusNode: FocusNode(
                                                  skipTraversal: true),
                                              child: Icon(
                                                _model.signupCofirmPasswordVisibility
                                                    ? Icons.visibility_outlined
                                                    : Icons
                                                        .visibility_off_outlined,
                                                size: 24.0,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signupPasswordTextController.text !=
                                  _model.signupCofirmPasswordTextController
                                      .text) {
                              ...
                              final user =
                                ...
                                context,
                                _model.signipEmailTextController.text,
